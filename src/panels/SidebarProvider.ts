...
import { isAuth, logout } from "../authentication/emailauthentication";
      ...
      switch (data.type) {
          ...
          getProjectFileArch(context)
            .then(() => {
              vscode.window.showInformationMessage(
                "File architecture creation complete."
              );
            })
            .catch((error) => {
              vscode.window.showErrorMessage(
                "Failed to create file architecture: " + error.message
              );
            });
          break;
        }
        ...
        case "generate-code-documentation": {
          ...
          generateCodeDocumentation(context)
            .then(() => {
              vscode.window.showInformationMessage(
                "Code documentation generated successfully."
              );
            })
            .catch((error) => {
              vscode.window.showErrorMessage(
                "Failed to generate code documentation: " + error.message
              );
            });
          break;
        }
