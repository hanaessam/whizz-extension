...
(function () {
  ...
  const fixCode = document.querySelector(".fix-code");
  const explainCode = document.querySelector(".explain-code");
  const unitTest = document.querySelector(".unit-test");

  const chatInput = document.querySelector(".chat-input");
  const sendButton = document.querySelector(".send-btn");
  const chatbox = document.querySelector(".chat-box");
  const switchCodeLanguage = document.querySelector(".switch-code-lang");
  const fileArch = document.querySelector(".file-arch");
  const codeDoc = document.querySelector(".code-doc");
  ...
  switchCodeLanguage.addEventListener("click", switchCodeLanguageClicked);
  fileArch.addEventListener("click", createFileArchClicked);
...
=======
  ...
  function unitTestClicked() {
    vscode.postMessage({
      type: "unit-test",
      value: "unit-test clicked",
    });
  }
